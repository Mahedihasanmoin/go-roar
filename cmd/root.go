...
func init() {
	...
	viper.SetDefault("database_url", "root:1234@/robi?charset=utf8&parseTime=True&loc=Local")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".go-roar" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".go-roar")
	}
